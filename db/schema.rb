...
ActiveRecord::Schema.define(version: 20140728044048) do
  ...
  add_index "disputes", ["result_transfer_id"], name: "index_disputes_on_result_transfer_id", using: :btree
  add_index "disputes", ["transfer_id"], name: "index_disputes_on_transfer_id", using: :btree
  ...
  add_index "transfers", ["group_id"], name: "index_transfers_on_group_id", using: :btree
